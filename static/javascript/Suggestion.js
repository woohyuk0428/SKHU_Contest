...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var queryParams_alr = "?" + encodeURIComponent("serviceKey") + "=" +
    key_new; /* Service Key*/
    ...
    .then((result) => fs.writeFileSync("subwayCode.json", result));
        ...
        var queryParams_sights = "?" + encodeURIComponent("serviceKey") + "=" +
        key_new; /* Service Key*/
        queryParams_sights += "&" + encodeURIComponent("numOfRows") + "=" + encodeURIComponent(
        "100090"); /* */
        queryParams_sights += "&" + encodeURIComponent("_type") + "=" + encodeURIComponent(
        "json"); /* */
        queryParams_sights += "&" + encodeURIComponent("subwayStationId") + "=" + encodeURIComponent(
            code); /* */
        ...
        for (j = 0; j < ResultArr.length; j++) {
            const googleSearchUrl =
                `https://www.google.com/search?tbm=isch&q=${encodeURIComponent(ResultArr[j])}`;
