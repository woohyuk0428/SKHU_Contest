...
const req_url = "http://swopenapi.seoul.go.kr/api/subway/" + key + "/json/realtimeStationArrival/0/50/";
const date =  new Date();
const openapi_url = `https://openapi.kric.go.kr/openapi/convenientInfo/stationTimetable?serviceKey=${fs.readFileSync("timetableapi.txt","utf-8")}`;
let dayCd = 0;
...
router.get("/", async (req, res) => {
    ...
    try {
        ...
        const url = req_url + encodeURI(station);
